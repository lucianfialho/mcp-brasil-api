...
async def get_veiculos_fipe(tipo_veiculo: str, marca: int, tabela_referencia: Optional[int] = None) -> List[Dict[str, Any]]:
    """
    ...
    """
    query_params = {"tabela_referencia": tabela_referencia} if tabela_referencia is not None else None
    return await make_request("veiculos_fipe", tipo_veiculo, str(marca), query_params=query_params)
